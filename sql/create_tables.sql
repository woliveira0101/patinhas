...
ALTER TABLE `adoptions` ADD CONSTRAINT `fk_adoptions_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
ALTER TABLE `adoptions` ADD CONSTRAINT `fk_adoptions_pets` FOREIGN KEY (`pet_id`) REFERENCES `pets` (`pet_id`) ON DELETE CASCADE;
...
ALTER TABLE `question_answers` ADD CONSTRAINT `fk_answers_questions` FOREIGN KEY (`question_id`) REFERENCES `form_questions` (`question_id`) ON DELETE CASCADE;
