      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav  align-items-center ms-auto fw-bolded fs-5">
          ...
          <li class="nav-item px-2">
            <a class="nav-link" href="/animais.html">Quero adotar</a>
          </li>
          <li class="nav-item px-2">
            <a class="nav-link" href="/form_doacao.html">Quero doar</a>
          </li>
          <li class="nav-item px-2 btn-group">
            <?php if (isset($_SESSION['user_login'])): ?>
              <button type="button" class="btn btn-warning text-dark nav-item fw-bolded fs-5 dropdown-toggle"
                data-bs-toggle="dropdown" aria-expanded="false"><?= htmlspecialchars($_SESSION['user_login']) ?></button>
              <ul class="dropdown-menu dropdown-menu-end dropdown-menu-start">
                <li><a class="dropdown-item" href="/user/profile">Meus dados</a></li>
                <li><a class="dropdown-item" href="/minhas_adocoes.html">Minhas adoções</a></li>
                <li><a class="dropdown-item" href="/minhas_doacoes.html">Minhas doações</a></li>
                <li>
